...
Q_DECLARE_METATYPE (QERadioButton::UserLevels)
Q_DECLARE_METATYPE (QERadioButton::DisplayAlarmStateOptions)
Q_DECLARE_METATYPE (QERadioButton::Formats)
Q_DECLARE_METATYPE (QERadioButton::Separators)
Q_DECLARE_METATYPE (QERadioButton::Notations)
Q_DECLARE_METATYPE (QERadioButton::ArrayActions)
Q_DECLARE_METATYPE (QERadioButton::UpdateOptions)
Q_DECLARE_METATYPE (QERadioButton::ProgramStartupOptionNames)
Q_DECLARE_METATYPE (QERadioButton::CreationOptionNames)
#endif
