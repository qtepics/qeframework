...
public:
   ...
   Q_PROPERTY (QE::DisplayAlarmStateOptions edgeAlarmStateOption READ getEdgeAlarmStateOptionProperty
...
public:
   ...
   QE::DisplayAlarmStateOptions getEdgeAlarmStateOptionProperty () const;       ///< Access function for #edgeAlarmStateOption property - refer to #edgeAlarmStateOption property for details
   void setEdgeAlarmStateOptionProperty (QE::DisplayAlarmStateOptions option);  ///< Access function for #edgeAlarmStateOption property - refer to #edgeAlarmStateOption property for details

   // Access with the need for that pesky type casting.
   //
   void setEdgeAlarmStateOption (QE::DisplayAlarmStateOptions option);
   QE::DisplayAlarmStateOptions getEdgeAlarmStateOption () const;
