...
//------------------------------------------------------------------------------
//
VideoWidget::VideoWidget(QEImage *parent) : QWidget(parent), owner (parent)
{
   paintExtraHandler = NULL;
   userContext = NULL;
   panning = false;
...
//------------------------------------------------------------------------------
//
void VideoWidget::setCustomisePaintHandler (CustomisePaintHandlers paintExtraHandlerIn,
                                            QObject* contextIn)
{
   paintExtraHandler = paintExtraHandlerIn;
   userContext = contextIn;
}

//------------------------------------------------------------------------------
//
VideoWidget::CustomisePaintHandlers VideoWidget::getCustomisePaintHandler () const
{
   return paintExtraHandler;
}
...
void VideoWidget::paintEvent(QPaintEvent* event )
{
   ...
   // Invoke customisation paint handler if applicable.
   if (paintExtraHandler) {
      paintExtraHandler (owner, painter, event->rect(), userContext);
   }
