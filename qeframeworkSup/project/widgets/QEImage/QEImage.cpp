...
/*
    slot: set PV name and substitutions for the nominated PV.
*/
void QEImage::usePvNameProperties( const QEPvNameProperties& pvNameProperties )
{
...
/*
    Implementation of QEWidget's virtual funtion to create the specific types of QEChannel required.
*/
...
void QEImage::establishConnection( unsigned int variableIndex )
{
   ...
   const variableIndexes pvi = static_cast<variableIndexes>(variableIndex);
   switch( pvi ) {
      ...
      case FORMAT_VARIABLE:
         QObject::connect( qca,  SIGNAL( valueUpdated( const QEStringValueUpdate& ) ),
                           this, SLOT  ( setFormat(    const QEStringValueUpdate& ) ) );
         QObject::connect( qca,  SIGNAL( connectionUpdated( const QEConnectionUpdate& ) ),
                           this, SLOT  ( connectionUpdated( const QEConnectionUpdate& ) ) );
         QObject::connect( this, SIGNAL( requestResend() ),
                           qca,  SLOT  ( resendLastData() ) );
      ...
      case BIT_DEPTH_VARIABLE:
         ...
         QObject::connect( qca,  SIGNAL( valueUpdated( const QEIntegerValueUpdate& ) ),
                           this, SLOT  ( setBitDepth ( const QEIntegerValueUpdate& ) ) );
         QObject::connect( qca,  SIGNAL( connectionUpdated( const QEConnectionUpdate& ) ),
                           this, SLOT  ( connectionUpdated( const QEConnectionUpdate& ) ) );
         QObject::connect( this, SIGNAL( requestResend() ),
                           qca,  SLOT  ( resendLastData() ) );
      ...
      case DATA_TYPE_VARIABLE:
         ...
         QObject::connect( qca,  SIGNAL( valueUpdated( const QEStringValueUpdate& ) ),
                           this, SLOT  ( setDataType ( const QEStringValueUpdate& ) ) );
         QObject::connect( qca,  SIGNAL( connectionUpdated( const QEConnectionUpdate& ) ),
                           this, SLOT  ( connectionUpdated( const QEConnectionUpdate& ) ) );
         QObject::connect( this, SIGNAL( requestResend() ),
                           qca,  SLOT  ( resendLastData() ) );
      ...
      case DIMENSION_2_VARIABLE:
         ...
         QObject::connect( qca,  SIGNAL( valueUpdated ( const QEIntegerValueUpdate& ) ),
                           this, SLOT  ( setDimension ( const QEIntegerValueUpdate& ) ) );
         QObject::connect( qca,  SIGNAL( connectionUpdated( const QEConnectionUpdate& ) ),
                           this, SLOT  ( connectionUpdated( const QEConnectionUpdate& ) ) );
         QObject::connect( this, SIGNAL( requestResend() ),
                           qca,  SLOT  ( resendLastData() ) );
      ...
      case CLIPPING_HIGH_VARIABLE:
         ...
         QObject::connect( qca,  SIGNAL( valueUpdated( const QEIntegerValueUpdate& ) ),
                           this, SLOT  ( setClipping ( const QEIntegerValueUpdate& ) ) );
         QObject::connect( qca,  SIGNAL( connectionUpdated( const QEConnectionUpdate& ) ),
                           this, SLOT  ( connectionUpdated( const QEConnectionUpdate& ) ) );
         QObject::connect( this, SIGNAL( requestResend() ),
                           qca,  SLOT  ( resendLastData() ) );
      ...
      case ROI4_H_VARIABLE:
         ...
         QObject::connect( qca,  SIGNAL( valueUpdated ( const QEIntegerValueUpdate& ) ),
                           this, SLOT  ( setROI       ( const QEIntegerValueUpdate& ) ) );
         QObject::connect( qca,  SIGNAL( connectionUpdated( const QEConnectionUpdate& ) ),
                           this, SLOT  ( connectionUpdated( const QEConnectionUpdate& ) ) );
         QObject::connect( this, SIGNAL( requestResend() ),
                           qca,  SLOT  ( resendLastData() ) );
      ...
      case LINE_PROFILE_THICKNESS_VARIABLE:
         ...
         QObject::connect( qca,  SIGNAL( valueUpdated ( const QEIntegerValueUpdate& ) ),
                           this, SLOT  ( setProfile   ( const QEIntegerValueUpdate& ) ) );
         QObject::connect( qca,  SIGNAL( connectionUpdated( const QEConnectionUpdate& ) ),
                           this, SLOT  ( connectionUpdated( const QEConnectionUpdate& ) ) );
         QObject::connect( this, SIGNAL( requestResend() ),
                           qca,  SLOT  ( resendLastData() ) );
      ...
      case BEAM_Y_VARIABLE:
         ...
         QObject::connect( qca,  SIGNAL( valueUpdated( const QEIntegerValueUpdate& ) ),
                           this, SLOT  ( setTargeting( const QEIntegerValueUpdate& ) ) );
         QObject::connect( qca,  SIGNAL( connectionUpdated( const QEConnectionUpdate& ) ),
                           this, SLOT  ( connectionUpdated( const QEConnectionUpdate& ) ) );
         QObject::connect( this, SIGNAL( requestResend() ),
                           qca,  SLOT  ( resendLastData() ) );
      ...
      case ELLIPSE_H_VARIABLE:
         ...
         QObject::connect( qca,  SIGNAL( valueUpdated( const QEIntegerValueUpdate& ) ),
                           this, SLOT  ( setEllipse  ( const QEIntegerValueUpdate& ) ) );
         QObject::connect( qca,  SIGNAL( connectionUpdated( const QEConnectionUpdate& ) ),
                           this, SLOT  ( connectionUpdated( const QEConnectionUpdate& ) ) );
         QObject::connect( this, SIGNAL( requestResend() ),
                           qca,  SLOT  ( resendLastData() ) );
      ...
      case ELLIPSE_R_VARIABLE:
         QObject::connect( qca,  SIGNAL( valueUpdated ( const QEFloatingValueUpdate& ) ),
                           this, SLOT  ( setEllipseFloat( const QEFloatingValueUpdate& ) ) );
         QObject::connect( qca,  SIGNAL( connectionUpdated( const QEConnectionUpdate& ) ),
                           this, SLOT  ( connectionUpdated( const QEConnectionUpdate& ) ) );
         QObject::connect( this, SIGNAL( requestResend() ),
                           qca,  SLOT  ( resendLastData() ) );
 ...
 */
void QEImage::connectionUpdated(const QEConnectionUpdate& update )
{
   const unsigned int vi = update.variableIndex;
   const variableIndexes pvi = static_cast<variableIndexes>(vi);
   ...
   {
      QString messageText;
      messageText.append( "Disconnected variable: " ).append( update.connectionInfo.variable() );
 ...
 */
void QEImage::setFormat( const QEStringValueUpdate& update )
{
   const unsigned int vi = update.variableIndex;
   const variableIndexes pvi = static_cast<variableIndexes>(vi);

   // Sanity check - Only deal with format variable
   if( pvi != FORMAT_VARIABLE)
   {
      return;
   }

   // Set the format based on the area detector format text
   if( !iProcessor.setFormat( update.value ) )
   {
      return;
   }
...
/*
    ...
    This is the slot used to recieve data updates from a QEChannel based class.
 */
void QEImage::setDimension( const QEIntegerValueUpdate& update )
{
   const unsigned int vi = update.variableIndex;
   const variableIndexes pvi = static_cast<variableIndexes>(vi);
   ...
   unsigned long uValue = MAX( 0, update.value );
...
/*
    ...
    This is the slot used to recieve data updates from a QEChannel based class.
 */
void QEImage::setBitDepth( const QEIntegerValueUpdate& update )
{
   const unsigned int vi = update.variableIndex;
   const variableIndexes pvi = static_cast<variableIndexes>(vi);

   // Sanity check - Only deal with bit depth
   if( pvi != BIT_DEPTH_VARIABLE)
   {
      return;
   }

   // Update the depth
   setBitDepth( update.value );
...
/*
    ...
    This is the slot used to recieve data updates from a QEChannel based class.
 */
void QEImage::setDataType( const QEStringValueUpdate& update )
{
   const unsigned int vi = update.variableIndex;
   const variableIndexes pvi = static_cast<variableIndexes>(vi);

   // Sanity check - Only deal with data type
   if( pvi != DATA_TYPE_VARIABLE)
   {
      return;
   }
   ...
   long value = 1;
   if(      update.value == "Int8" )    value = 8;  // Treat as effectively unsigned.
   else if( update.value == "UInt8" )   value = 8;
   else if( update.value == "Int16" )   value = 15;
   else if( update.value == "UInt16" )  value = 16;
   else if( update.value == "Int32" )   value = 24; // Todo:??? Should be 31. change to 31 when all pixel information is held in unsigned int or long. (mostly in brightness / contrast code where int is used to woek well with sliders)
   else if( update.value == "UInt32" )  value = 24; // Todo:??? Should be 32. change to 32 when all pixel information is held in unsigned int or long. (mostly in brightness / contrast code where int is used to woek well with sliders)
   else if( update.value == "Float32" ) value = 16; // Bit depth cannot be derived. Assume 16 bit (actually, setting bit depth from the data type is always an assumption!)
   else if( update.value == "Float64" ) value = 16; // Bit depth cannot be derived. Assume 16 bit (actually, setting bit depth from the data type is always an assumption!)
   else {
      return;
   }
...
/*
    ...
    This is the slot used to recieve data updates from a QEChannel based class.
 */
void QEImage::setClipping( const QEIntegerValueUpdate& update)
{
   const unsigned int vi = update.variableIndex;
   const variableIndexes pvi = static_cast<variableIndexes>(vi);
   ...
   switch( pvi )
   {
      case CLIPPING_ONOFF_VARIABLE: iProcessor.setClippingOn(   (update.value>0)?true:false ); break;
      case CLIPPING_LOW_VARIABLE:   iProcessor.setClippingLow(  (unsigned int)update.value );  break;
      case CLIPPING_HIGH_VARIABLE:  iProcessor.setClippingHigh( (unsigned int)update.value );  break;
      default: break;  // avoid warning
   }
...
/*
    ...
    This is the slot used to recieve data updates from a QEChannel based class.
 */
void QEImage::setROI( const QEIntegerValueUpdate& update)
{
   const unsigned int vi = update.variableIndex;
   const variableIndexes pvi = static_cast<variableIndexes>(vi);
   ...
   else
   {
      ...
      switch( pvi )
      {
         case ROI1_X_VARIABLE:  roiInfo[0].setX( update.value ); break;
         case ROI1_Y_VARIABLE:  roiInfo[0].setY( update.value ); break;
         case ROI1_W_VARIABLE:  roiInfo[0].setW( update.value ); break;
         case ROI1_H_VARIABLE:  roiInfo[0].setH( update.value ); break;
         case ROI2_X_VARIABLE:  roiInfo[1].setX( update.value ); break;
         case ROI2_Y_VARIABLE:  roiInfo[1].setY( update.value ); break;
         case ROI2_W_VARIABLE:  roiInfo[1].setW( update.value ); break;
         case ROI2_H_VARIABLE:  roiInfo[1].setH( update.value ); break;
         case ROI3_X_VARIABLE:  roiInfo[2].setX( update.value ); break;
         case ROI3_Y_VARIABLE:  roiInfo[2].setY( update.value ); break;
         case ROI3_W_VARIABLE:  roiInfo[2].setW( update.value ); break;
         case ROI3_H_VARIABLE:  roiInfo[2].setH( update.value ); break;
         case ROI4_X_VARIABLE:  roiInfo[3].setX( update.value ); break;
         case ROI4_Y_VARIABLE:  roiInfo[3].setY( update.value ); break;
         case ROI4_W_VARIABLE:  roiInfo[3].setW( update.value ); break;
         case ROI4_H_VARIABLE:  roiInfo[3].setH( update.value ); break;
         default: break;  // avoid warning
      }
...
/*
     ...
     This is the slot used to recieve data updates from a QEChannel based class.
  */
void QEImage::setProfile( const QEIntegerValueUpdate& update)
{
   const unsigned int vi = update.variableIndex;
   const variableIndexes pvi = static_cast<variableIndexes>(vi);
   ...
   else
   {
      ...
      switch( pvi )
      {
         case PROFILE_H1_VARIABLE:             hSlice1Y = update.value;                break;
         case PROFILE_H2_VARIABLE:             hSlice2Y = update.value;                break;
         case PROFILE_H3_VARIABLE:             hSlice3Y = update.value;                break;
         case PROFILE_H4_VARIABLE:             hSlice4Y = update.value;                break;
         case PROFILE_H5_VARIABLE:             hSlice5Y = update.value;                break;
         case PROFILE_V1_VARIABLE:             vSlice1X = update.value;                break;
         case PROFILE_V2_VARIABLE:             vSlice2X = update.value;                break;
         case PROFILE_V3_VARIABLE:             vSlice3X = update.value;                break;
         case PROFILE_V4_VARIABLE:             vSlice4X = update.value;                break;
         case PROFILE_V5_VARIABLE:             vSlice5X = update.value;                break;
         case PROFILE_H1_THICKNESS_VARIABLE:   hSlice1Thickness = update.value;        break;
         case PROFILE_H2_THICKNESS_VARIABLE:   hSlice2Thickness = update.value;        break;
         case PROFILE_H3_THICKNESS_VARIABLE:   hSlice3Thickness = update.value;        break;
         case PROFILE_H4_THICKNESS_VARIABLE:   hSlice4Thickness = update.value;        break;
         case PROFILE_H5_THICKNESS_VARIABLE:   hSlice5Thickness = update.value;        break;
         case PROFILE_V1_THICKNESS_VARIABLE:   vSlice1Thickness = update.value;        break;
         case PROFILE_V2_THICKNESS_VARIABLE:   vSlice2Thickness = update.value;        break;
         case PROFILE_V3_THICKNESS_VARIABLE:   vSlice3Thickness = update.value;        break;
         case PROFILE_V4_THICKNESS_VARIABLE:   vSlice4Thickness = update.value;        break;
         case PROFILE_V5_THICKNESS_VARIABLE:   vSlice5Thickness = update.value;        break;
         case LINE_PROFILE_X1_VARIABLE:        lineProfileInfo.setX1( update.value );  break;
         case LINE_PROFILE_Y1_VARIABLE:        lineProfileInfo.setY1( update.value );  break;
         case LINE_PROFILE_X2_VARIABLE:        lineProfileInfo.setX2( update.value );  break;
         case LINE_PROFILE_Y2_VARIABLE:        lineProfileInfo.setY2( update.value );  break;
         case LINE_PROFILE_THICKNESS_VARIABLE: profileThickness = 1;                   break;
         default: break;  // avoid warning
      }
...
/*
    ...
    This is the slot used to recieve data updates from a QEChannel based class.
 */
void QEImage::setEllipse( const QEIntegerValueUpdate& update)
{
   const unsigned int vi = update.variableIndex;
   const variableIndexes pvi = static_cast<variableIndexes>(vi);
   ...
   if( update.alarmInfo.isInvalid() ) {
      ...
      switch( pvi ) {
         case ELLIPSE_X_VARIABLE: ellipseInfo.setX( update.value ); break;
         case ELLIPSE_Y_VARIABLE: ellipseInfo.setY( update.value ); break;
         case ELLIPSE_W_VARIABLE: ellipseInfo.setW( update.value ); break;
         case ELLIPSE_H_VARIABLE: ellipseInfo.setH( update.value ); break;
         default: break;  // avoid warning
      }
 ...
 */
void QEImage::setEllipseFloat( const QEFloatingValueUpdate& update)
{
   const unsigned int vi = update.variableIndex;
   const variableIndexes pvi = static_cast<variableIndexes>(vi);
   ...
   else
   {
      // Save the ellipse data
      switch( pvi ) {
         case ELLIPSE_R_VARIABLE: ellipseInfo.setR( update.value ); break;
         default: break;  // avoid warning
      }
...
/*
    ...
    This is the slot used to recieve data updates from a QEChannel based class.
 */
void QEImage::setTargeting( const QEIntegerValueUpdate& update)
{
   const unsigned int vi = update.variableIndex;
   const variableIndexes pvi = static_cast<variableIndexes>(vi);
   ...
   else
   {
      ...
      switch( pvi )
      {
         case TARGET_X_VARIABLE:  targetInfo.setX( update.value ); break;
         case TARGET_Y_VARIABLE:  targetInfo.setY( update.value ); break;
         case BEAM_X_VARIABLE:    beamInfo.setX( update.value );   break;
         case BEAM_Y_VARIABLE:    beamInfo.setY( update.value );   break;
         default: break;  // avoid warning
      }
...
void QEImage::setPvaImage ( const QEVariantUpdate& update )
{
   ...
   // set the format.
   //
   this->setFormat ({imageData.getColourMode(), alarmInfo, timeStamp, FORMAT_VARIABLE, update.isMetaUpdate});

   // set the data type.
   //
   this->setDataType ({imageData.getDataType(), alarmInfo, timeStamp, DATA_TYPE_VARIABLE, update.isMetaUpdate});
   ...
   this->setDimension ({ndims, alarmInfo, timeStamp, NUM_DIMENSIONS_VARIABLE, false});

   this->setDimension ({imageData.getDimensionSize(0), alarmInfo, timeStamp, DIMENSION_0_VARIABLE, update.isMetaUpdate});
   this->setDimension ({imageData.getDimensionSize(1), alarmInfo, timeStamp, DIMENSION_1_VARIABLE, update.isMetaUpdate});
   if (ndims == 3) {
      this->setDimension ({imageData.getDimensionSize(2), alarmInfo, timeStamp, DIMENSION_2_VARIABLE, update.isMetaUpdate});
   }
